...
exports.run = (client, message, params) => {
  ...
  if(params[0]) if(params[0] === 'sunucu-ikon'){
    ...
    Jimp.read(message.guild.iconURL, function (err, image){
        ...
        image.invert().write('bot.png');
        setTimeout(() => {
          message.channel.sendFile('bot.png');
          using = false;
        }, 500);
    });
    return;
...
exports.help = {
  name: 'siyahbeyaz',
  description: 'Avatarı siyah beyaz yapar.',
  usage: 'siyahbeyaz [@<kişi ismi>]'
};